...
const char* ssid = "myhotspot"; //WiFi SSID 
const char* password = "itsmejeni"; //WiFi Password 
...
Department of Computer Engineering 62 D.N.Patel College of Engineering Shahada 
